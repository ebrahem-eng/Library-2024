...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  ...
  <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link  active" href="<?php echo $basePath; ?>Teacher/index.php">
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?php echo $basePath; ?>Teacher/Lecture/SpecializationTeacher.php" id="lectureDropdown">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
  ...
  <path d="M1 5v-.5a.5.5 0 0 1 1 0V5h.5a.5.5 0 0 1 0 1h-2a.5.5 0 0 1 0-1zm0 3v-.5a.5.5 0 0 1 1 0V8h.5a.5.5 0 0 1 0 1h-2a.5.5 0 0 1 0-1zm0 3v-.5a.5.5 0 0 1 1 0v.5h.5a.5.5 0 0 1 0 1h-2a.5.5 0 0 1 0-1z"/>
          ...
          <span class="nav-link-text ms-1">Lecture Manage</span>
        </a>
        <!-- Dropdown content -->
        <ul class="dropdown-menu" id="lectureDropdownMenu">
          <li><a href="<?php echo $basePath; ?>Teacher/Lecture/SpecializationTeacher.php" style="margin-left: 50px;">Lecture Table</a></li>
          <br>
