          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Specialization</p>
            ...
            ");
                      ...
                      $count = $specializations->rowCount();
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Subject</p>
                    <h5 class="font-weight-bolder mb-0">
                      <?php
                      include('../Config/config.php');
                      $teacherID = $_SESSION['teacher_id'];
                      $subjects = $database->prepare("SELECT * FROM subjectTeacher WHERE teacher_id = :teacherID");
