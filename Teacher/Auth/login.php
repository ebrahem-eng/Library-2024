      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            ...
            <p class="text-lead text-white">Welcome Teacher You Can Login And Start Upload Lecture.</p>
          </div>
        </div>
      </div>
    </div>
            ...
            <div class="card-body">
              <form role="form text-left" action="login_handler.php" method="post">
                ...
                <div class="text-center">
                  <button type="submit" name="teacherLogin" class="btn bg-gradient-dark w-100 my-4 mb-2">Login</button>
                </div>
              </form>
