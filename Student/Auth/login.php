...
<head>
    ...
    <style>
        body {
            background-image: url('../assets/img/bookTest.jpg');
...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <section class="min-vh-100 mb-8">
        <div class="page-header align-items-start min-vh-70 pt-12 pb-12 m-3 border-radius-lg">
            <!--      <span class="mask bg-gradient-dark opacity-6"></span>-->
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-5 text-center mx-auto">
                        <h1 class="text-white mb-2 mt-5">Welcome!</h1>
                        <p class="text-lead text-white">Welcome Student You Can Login And Start Download Lecture With More Security And Perfermonce.</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
                    <div class="card z-index-0">
                        ...
                        <div class="card-body">
                            ...
                            <form role="form text-left" action="login_handler.php" method="post">
                                <div class="mb-3">
                                ...
                                <div class="text-center">
                                    <button type="submit" name="studentLogin" class="btn bg-gradient-dark w-100 my-4 mb-2">Login</button>
                                </div>
                            </form>
