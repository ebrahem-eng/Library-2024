          ...
          <div class="row">
                ...
                <div class="card-body">
                  ...
                  <form role="form" method="POST" action="login_handler.php">
                    ...
                    <div class="text-center">
                      <button type="submit" class="btn bg-gradient-info w-100 mt-4 mb-0" name="loginAdmin">Login</button>
                    </div>
                  </form>
            ...
            <div class="col-md-6">
              <div class="oblique position-absolute top-0  h-100 d-md-block d-none me-n4">
                <div class="oblique-image bg-cover position-absolute fixed-top ms-auto h-100 z-index-0 ms-n6" style="background-image:url('../assets/img/open-book-with-fairytale-scene.jpg')"></div>
              </div>
            </div>
          </div>
        </div>
