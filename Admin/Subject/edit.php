                            ...
                            <div class="container mt-3">
                                ...
                                <form action="update.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    if (isset($_POST['edit'])) {
                                        ...
                                        $id = $_POST['id'];
                                        $subjects = $database->prepare("SELECT * FROM subject WHERE id=:id");
                                        $subjects->bindParam("id", $id);
                                        $subjects->execute();
                                    ...
                                    ?>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-3 ">
                                                    ...
                                                    <input type="text" class="form-control" value="<?php echo $subject['name'] ?>" name="name">
                                                </div>

                                                <div class="col-md-6 mb-3 ">
                                                    <label for="name">Year Number:</label>
                                                    <input type="text" class="form-control" value="<?php echo $subject['year'] ?>" name="yearNumber">
                                                </div>
