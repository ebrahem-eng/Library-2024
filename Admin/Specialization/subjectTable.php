        ...
        <div class="container-fluid py-4">
            <div class="row">
              ...
              <button type="button" class="btn-close" onclick="redirectToIndex()" aria-label="Close"></button>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <h6>Subjects Specialization Table</h6>
                                </div>
                                <div class="col-3">
                                    <form method="post" action='addNewSubject.php'>
                                        <input type="hidden" value="<?php echo $specializationID ?>" name="specializationID" />
                                        <button type='submit' class="badge badge-sm bg-gradient-dark" name='addSpecialization'>Add New Subject</button>
                                    </form>
                                </div>
                                <div class="col-3">
                                    <form method="post" action='chooseSubject.php'>
                                        <input type="hidden" value="<?php echo $specializationID ?>" name="specializationID" />
                                        <button type='submit' class="badge badge-sm bg-gradient-primary" name='addSpecialization'>Choose From Subject</button>
                                    </form>
                                </div>
                            </div>
