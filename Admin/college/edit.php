                            ...
                            <div class="container mt-3">
                                ...
                                <form action="update.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    if (isset($_POST['edit'])) {
                                        ...
                                        $id = $_POST['id'];
                                        $colleges = $database->prepare("SELECT * FROM college WHERE id=:id");
                                        $colleges->bindParam("id", $id);
                                        $colleges->execute();
                                    ...
                                    ?>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-3 ">
                                                    ...
                                                    <input type="text" class="form-control" value="<?php echo $college['name'] ?>" name="name">
                                                </div>

                                                <div class="col-md-6 mb-3 ">
                                                    <label for="name">Number :</label>
                                                    <input type="text" class="form-control" value="<?php echo $college['numberYear'] ?>" name="numberYear">
                                                </div>
