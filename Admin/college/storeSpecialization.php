...
if (isset($_POST['send'])) {
    ...
    $uploadDirectory = '../Specialization/Image/';
    ...
    if (getimagesize($_FILES['img']['tmp_name']) !== false) {
        if (move_uploaded_file($_FILES['img']['tmp_name'], $targetFilePath)) {
            ...
            if ($stmt->execute()) {
                header("location:index.php?success=1&type=success&message=Specialization Created And Added For College Successfully", true);
            } else {
