                            ...
                            <div class="table-responsive p-0">
                                <table class="table align-items-center mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        $checkStmt = $database->prepare($specializations);
                                        $checkStmt->bindParam(":teacherID", $teacherID);
                                        $checkStmt->execute();


                                        $specializationsResult = $checkStmt->fetchAll(PDO::FETCH_ASSOC);


                                        if (!empty($specializationsResult)) {

                                            foreach ($specializationsResult as $row) {
                                                $specializationIDTeacher = $row['specializationID'];
                                                // echo "this is specialization ID teacher: " . $specializationIDTeacher;
                                                ...
                                                $subjects = $database->prepare("SELECT 
                                                                                ...
                                                                                WHERE subjectSpecialization.specialization_id = :specializationID");

                                                $subjects->bindParam(":specializationID", $specializationIDTeacher);
                                                $subjects->execute();


                                                $subjectsResult = $subjects->fetchAll(PDO::FETCH_ASSOC);
                                        ...
                                        ?>
                                                    <tr>
                                                            ...
                                                            <div class="d-flex px-2 py-1">
                                                                <div>
                                                                    ...
                                                                    <?php if (!empty($subject['subjectImg'])) : ?>
                                                                        <img src="<?php echo $subject['subjectImg']; ?>" class="avatar avatar-sm me-3" alt="user1">
                                                                    <?php else : ?>
                                                        ...
                                                        <td>
                                                            <form method="post" action="storeChooseSubject.php">
                                                                ...
                                                                <button type='submit' class="badge badge-sm bg-gradient-success" style="margin-right: -30px;" name='chooseSubject'>Choose</button>
                                                            </form>
                                                        </td>
                                        ...
                                        <?php        }
                                            ...
                                            echo "No specializations found for the given teacher ID.";
                                        } ?>
                                    </tbody>
                                </table>
                            </div>
